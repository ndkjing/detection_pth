...
from ssd.mobilenet_v3_ssd_lite import create_mobilenetv3_ssd_lite,create_mobilenetv3_ssd_lite_predictor

from datasets.voc_dataset import VOCDataset
from datasets.open_images import OpenImagesDataset
from datasets.egohands_dataset import EGODataset

from utils.ssd import measurements, box_utils
from utils.ssd.misc import str2bool, Timer
import argparse
import pathlib
import numpy as np
import logging
...
DEVICE = torch.device("cuda:3" if torch.cuda.is_available() and args.use_cuda else "cpu")
...
if __name__ == '__main__':
    ...
    if args.dataset_type == "voc":
        ...
        dataset = EGODataset(args.dataset,is_test=True)
    ...
    if args.net == 'vgg16-ssd':
        ...
        net = create_mobilenetv3_ssd_lite(len(class_names), width_mult=args.mb2_width_mult, is_test=True)
    else:
