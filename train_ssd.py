...
from utils.ssd.misc import str2bool, Timer, freeze_net_layers, store_labels
...
from ssd.mobilenet_v3_ssd_lite import create_mobilenetv3_ssd_lite
...
from data.egohands_dataset import EGODataset
...
parser.add_argument('--datasets', nargs='+', help='Dataset directory path')  # 一个或者多个参数
...
device_id = 2
DEVICE = torch.device("cuda:%d"%device_id if torch.cuda.is_available() and args.use_cuda else "cpu")
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        create_net = lambda num: create_mobilenetv2_ssd_lite(num, width_mult=args.mb2_width_mult,device_id=device_id)
        config = mobilenetv1_ssd_config
    elif args.net == 'mb3-ssd-lite':  # mobilenet_v3还有点问题
    ...
    if args.dataset_type == "voc":
        ...
        val_dataset = EGODataset(args.validation_dataset,
...
#  训练命令
#python train_ssd.py  --dataset_type voc  --datasets /Data/jing/VOCdevkit/VOC2007 /Data/jing/VOCdevkit/VOC2012 --validation_dataset /Data/jing/VOCdevkit/VOC2007/ --net mb2-ssd-lite   --scheduler cosine --lr 0.01 --t_max 200 --validation_epochs 5 --num_epochs 20
