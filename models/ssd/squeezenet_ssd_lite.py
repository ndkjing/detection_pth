...
def create_squeezenet_ssd_lite(num_classes, is_test=False,device_id=None):
...
def create_squeezenet_ssd_lite_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=torch.device('cpu'),device_id=None):
